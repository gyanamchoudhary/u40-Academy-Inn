        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr]">
          <div>
            <a href="/" className="inline-flex items-center gap-3">
              <img
                src="/assets/u40-mark.svg"
                alt=""
                className="h-12 w-12"
                width="48"
                height="48"
              />
              <span className="text-lg font-extrabold">U40 Academy Inn</span>
            </a>
            <p className="mt-5 max-w-md text-sm leading-7 text-white/50">
              Residential science education for Classes IX–XII, NEET, IIT-JEE
              and WBJEE aspirants in Malda, West Bengal.
            </p>
          </div>
          <nav
            className="grid grid-cols-2 gap-x-8 gap-y-3 self-start sm:grid-cols-3"
