    ...
    <footer className="bg-[#111318] text-white">
      <div className="mx-auto max-w-[90rem] px-5 py-12 sm:px-8 lg:px-10">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr]">
          <div>
            <a href="/" className="inline-flex items-center gap-3"><img src="/assets/u40-mark.svg" alt="" className="h-12 w-12" width="48" height="48" /><span className="text-lg font-extrabold">U40 Academy Inn</span></a>
        ...
        <div className="mt-12 flex flex-col gap-5 border-t border-white/15 pt-6 text-xs text-white/45 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-5"><a href="#" className="inline-flex items-center gap-2 text-white/70 hover:text-white">Back to top <ArrowUpRight className="h-3.5 w-3.5" /></a><a href="/privacy/" className="hover:text-white">Privacy</a><a href="/terms/" className="hover:text-white">Terms</a></div>
        </div>
      </div>
    </footer>
  );
