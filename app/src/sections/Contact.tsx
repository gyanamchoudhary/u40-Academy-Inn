...
const mapUrl = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(institute.address)}`;
      ...
      <div className="mx-auto max-w-[90rem] px-5 sm:px-8 lg:px-10">
        <div className="page-grid gap-y-12">
          <div className="col-span-12 lg:col-span-7">
            ...
            <h2 className="mt-5 max-w-[13ch] text-5xl font-semibold leading-[0.96] tracking-[-0.055em] sm:text-6xl lg:text-7xl">See the campus. Meet the people.</h2>
          </div>
          <div className="col-span-12 flex flex-col justify-end lg:col-span-5">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <a href={mapUrl} target="_blank" rel="noreferrer" className="inline-flex min-h-12 items-center justify-center gap-2 bg-white px-5 text-sm font-bold text-[#2046d8] transition hover:bg-[#d9f66f]">Open directions <ArrowUpRight className="h-4 w-4" /></a>
