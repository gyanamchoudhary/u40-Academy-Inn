        ...
        <div className="page-grid gap-y-12">
          ...
          <div className="col-span-12 flex flex-col justify-end lg:col-span-5">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <a href={mapUrl} target="_blank" rel="noopener noreferrer" aria-label="Open directions in Google Maps (opens in new tab)" className="inline-flex min-h-12 items-center justify-center gap-2 bg-white px-5 text-sm font-bold text-[#2046d8] transition hover:bg-[#d9f66f]">Open directions <ArrowUpRight className="h-4 w-4" /></a>
