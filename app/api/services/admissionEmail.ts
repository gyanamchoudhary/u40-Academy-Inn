...
export function createAdmissionEmail(
  ...
  return {
    subject: `[${referenceCode}] New admission inquiry — ${input.studentName.replace(/[\r\n]+/g, " ")}`,
    text: [
